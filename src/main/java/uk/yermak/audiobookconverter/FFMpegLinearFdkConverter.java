 ...
 */
public class FFMpegLinearFdkConverter implements Concatenator {
    ...
    public FFMpegLinearFdkConverter(Conversion conversion, String outputFileName, String metaDataFileName, String fileListFileName, OutputParameters outputParameters, ProgressCallback callback) {
