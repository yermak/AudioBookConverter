 ...
 */
public class FFMpegFdkConverter implements Callable<ConverterOutput>, Converter {
    ...
    public FFMpegFdkConverter(Conversion conversion, OutputParameters outputParameters, MediaInfo mediaInfo, String outputFileName, ProgressCallback callback) {
