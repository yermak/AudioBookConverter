...
cd target\image
7z.exe a -t7z -mx5 -mmt -sfx7z.sfx ..\release\AudioBookConverter-Portable-%APP_VERSION%.exe AudioBookConverter
7z.exe a -tzip -mx5 -mmt ..\release\AudioBookConverter-Portable-%APP_VERSION%.zip AudioBookConverter
cd ..\..
