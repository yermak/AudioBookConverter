...
$JAVA_HOME/bin/jpackage --app-version $APP_VERSION  --license-file README.md --icon AudioBookConverter.ico -t deb --name AudioBookConverter --vendor Recoupler --input target/package/audiobookconverter-$APP_VERSION/audiobookconverter-$APP_VERSION/app --main-jar lib/audiobookconverter-$APP_VERSION.jar --runtime-image target/fx-jre
